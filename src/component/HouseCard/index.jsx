...
const HouseCard = ({ imageSrc, title, features }) => {
  ...
  return (
    <div>
    <div className="w-[300px] h-[200px] m-4 mt-0 bg-white rounded-lg shadow-md relative -z-1">
      <div className="bg-white shadow-sm w-[250px] h-[100px] z-10 absolute right-6 top-[150px] rounded-lg p-4">
          ...
          <ul className="flex justify-start items-left w-full space-y-2">
            {features.map((feature, index) => (
              <li key={index} className="flex items-center text-gray-700">
                ...
                style={{fill: 'black',
                    transform: msFilter
                }}><path d="M21 4H3a1 1 0 0 0-1 1v14a1 1 0 0 0 1 1h18a1 1 0 0 0 1-1V5a1 1 0 0 0-1-1zm-1 11a3 3 0 0 0-3 3H7a3 3 0 0 0-3-3V9a3 3 0 0 0 3-3h10a3 3 0 0 0 3 3v6z"></path><path d="M12 8c-2.206 0-4 1.794-4 4s1.794 4 4 4 4-1.794 4-4-1.794-4-4-4zm0 6c-1.103 0-2-.897-2-2s.897-2 2-2 2 .897 2 2-.897 2-2 2z"></path></svg>
               &nbsp; {feature}
              </li>
            ))}
          </ul>
