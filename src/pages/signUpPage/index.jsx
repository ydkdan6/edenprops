  ...
  const msFilter = 'rotate(-0.9deg)'; 
    ...
    return (
        ...
        <div className="w-[100%] h-full mt-[150px] ml-4 md:w-1/2 p-4 overflow-hidden">
          <form className="p-4 w-[100%] ml-3 md:w-[80%] md:pt-1 md:p-12 md:ml-[55px] md:h-[89%] pt-[20px] shadow-md h-[80%] overflow-hidden" onSubmit={handleSubmit}>
            <Text className="text-center text-[28px] pb-4">Create account</Text>
            ...
            <label htmlFor="email" className="mb-2 text-gray-700">Full Name:</label>
            <div className="flex items-center border border-gray-300 rounded-lg">
            <svg className='pl-2' xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill='rgba(0,0,0,0.2)'><path d="M7.5 6.5C7.5 8.981 9.519 11 12 11s4.5-2.019 4.5-4.5S14.481 2 12 2 7.5 4.019 7.5 6.5zM20 21h1v-1c0-3.859-3.141-7-7-7h-4c-3.86 0-7 3.141-7 7v1h17z"></path></svg>
              <input
                type="text"
                id="fullName"
      ...
      <path d="M17.707 12.293a.999.999 0 0 0-1.414 0l-1.594 1.594c-.739-.22-2.118-.72-2.992-1.594s-1.374-2.253-1.594-2.992l1.594-1.594a.999.999 0 0 0 0-1.414l-4-4a.999.999 0 0 0-1.414 0L3.581 5.005c-.38.38-.594.902-.586 1.435.023 1.424.4 6.37 4.298 10.268s8.844 4.274 10.269 4.298h.028c.528 0 1.027-.208 1.405-.586l2.712-2.712a.999.999 0 0 0 0-1.414l-4-4.001zm-.127 6.712c-1.248-.021-5.518-.356-8.873-3.712-3.366-3.366-3.692-7.651-3.712-8.874L7 4.414 9.586 7 8.293 8.293a1 1 0 0 0-.272.912c.024.115.611 2.842 2.271 4.502s4.387 2.247 4.502 2.271a.991.991 0 0 0 .912-.271L17 14.414 19.586 17l-2.006 2.005z">
          ...
          <div className="flex justify-between items-center mb-4">
            <div className="flex items-center">
              ...
              <label htmlFor="remember" className="text-gray-700">I agree to terms & condition</label>
            </div>
          ...
          <Button className="w-[50%] text-center ml-[75px] md:ml-[97px] mb-4 rounded-[20px]">
            <Link to='/dashboard' className='text-white hover:text-black'>Sign up
            </Link>
            </Button>
    
          <Text className="text-center pt-12 text-gray-600 mb-4">Already have an account? <Link to='/login' className="text-blue-500 cursor-pointer">Log in</Link></Text>
