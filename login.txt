...
import './style.css';
// import { ReactComponent as GoogleIcon } from '../../icons/google.png'; 
    ...
    <form className="form p-4" onSubmit={handleSubmit}>
      <div className="flex flex-col mb-4">
        ...
        <div className="flex items-center border border-gray-300 rounded-lg">
          <svg className="ml-2" height="20" viewBox="0 0 32 32" width="20" xmlns="http://www.w3.org/2000/svg">
      ...
      <div className="flex flex-col mb-4">
        ...
        <div className="flex items-center border border-gray-300 rounded-lg">
          <svg className="ml-2" height="20" viewBox="-64 0 512 512" width="20" xmlns="http://www.w3.org/2000/svg">
          ...
          />
          <svg className="ml-2" viewBox="0 0 576 512" height="20" xmlns="http://www.w3.org/2000/svg">
      ...
      <Text className="text-gray-600 mb-4">Don't have an account? <span className="text-blue-500 cursor-pointer">Sign Up</span></Text>
